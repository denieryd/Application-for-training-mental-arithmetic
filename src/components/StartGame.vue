            ...
            <div v-if="testingComplete">
              ...
              <table class="table table-sm">
                ...
                <tr v-for="result in listResultTest">
                  <td :class="result.userAnswer === result.Correct ? 'correct-answer' : 'wrong-answer' ">{{result.Example}}</td>
                  <td :class="result.userAnswer === result.Correct ? 'correct-answer' : 'wrong-answer' ">{{result.userAnswer}}</td>
                  <td :class="result.userAnswer === result.Correct ? 'correct-answer' : 'wrong-answer' ">{{result.Correct}}</td>
                </tr>
                </tbody>
              </table>
            </div>
